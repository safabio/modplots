...
Volcano plot function for Seurat and DESeq2 generated DE tables. The backbone of the function is taken from [https://erikaduan.github.io/posts/2021-01-02-volcano-plots-with-ggplot2/](here).
...
Gg6 gene ID and name table. For details use: \code{?gnames}.
